...
{
    Product* returnThis = new Movie(categoryID(), prodName_, price_, qty_, genre_, rating_);
		return returnThis;
}
...
{
    Product* returnThis = new Book(categoryID(), prodName_, price_, qty_, author_, isbn_);
		return returnThis;
}
...
{
    Product* returnThis = new Clothing(categoryID(), prodName_, price_, qty_, size_, brand_);
		return returnThis;
}
